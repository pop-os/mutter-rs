...
/// [`ActorExt::set_text_direction()`][crate::prelude::ActorExt::set_text_direction()].
///
/// # Returns
///
...
pub fn default_text_direction() -> TextDirection {
    unsafe {
        from_glib(ffi::clutter_get_default_text_direction())
    }
}

/// Retrieves the [`pango::FontMap`][crate::pango::FontMap] instance used by Clutter.
/// You can use the global font map object with the COGL
/// Pango API.
///
/// # Returns
///
/// the [`pango::FontMap`][crate::pango::FontMap] instance. The returned
///  value is owned by Clutter and it should never be unreferenced.
#[cfg(any(feature = "v1_0", feature = "dox"))]
#[cfg_attr(feature = "dox", doc(cfg(feature = "v1_0")))]
#[doc(alias = "clutter_get_font_map")]
#[doc(alias = "get_font_map")]
pub fn font_map() -> Option<pango::FontMap> {
    unsafe {
        from_glib_none(ffi::clutter_get_font_map())
    }
}
