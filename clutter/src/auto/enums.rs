...
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "ClutterOrientation")]
pub enum Orientation {
    #[doc(alias = "CLUTTER_ORIENTATION_HORIZONTAL")]
    Horizontal,
    #[doc(alias = "CLUTTER_ORIENTATION_VERTICAL")]
    Vertical,
#[doc(hidden)]
    __Unknown(i32),
}
...
impl IntoGlib for Orientation {
    ...
    fn into_glib(self) -> ffi::ClutterOrientation {
        match self {
            Self::Horizontal => ffi::CLUTTER_ORIENTATION_HORIZONTAL,
            Self::Vertical => ffi::CLUTTER_ORIENTATION_VERTICAL,
            Self::__Unknown(value) => value,
}
    }
}
...
impl FromGlib<ffi::ClutterOrientation> for Orientation {
    unsafe fn from_glib(value: ffi::ClutterOrientation) -> Self {
        match value {
            ffi::CLUTTER_ORIENTATION_HORIZONTAL => Self::Horizontal,
            ffi::CLUTTER_ORIENTATION_VERTICAL => Self::Vertical,
            value => Self::__Unknown(value),
}
    }
}
...
/// Specifies the type of requests for a [`Actor`][crate::Actor].
#[cfg(any(feature = "v0_8", feature = "dox"))]
#[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8")))]
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Hash)]
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "ClutterRequestMode")]
pub enum RequestMode {
    #[doc(alias = "CLUTTER_REQUEST_HEIGHT_FOR_WIDTH")]
    HeightForWidth,
    #[doc(alias = "CLUTTER_REQUEST_WIDTH_FOR_HEIGHT")]
    WidthForHeight,
    #[doc(alias = "CLUTTER_REQUEST_CONTENT_SIZE")]
    ContentSize,
#[doc(hidden)]
    __Unknown(i32),
}
...
impl fmt::Display for RequestMode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RequestMode::{}", match *self {
...
#[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8")))]
#[doc(hidden)]
impl IntoGlib for RequestMode {
    type GlibType = ffi::ClutterRequestMode;

    fn into_glib(self) -> ffi::ClutterRequestMode {
        match self {
            Self::HeightForWidth => ffi::CLUTTER_REQUEST_HEIGHT_FOR_WIDTH,
            Self::WidthForHeight => ffi::CLUTTER_REQUEST_WIDTH_FOR_HEIGHT,
            Self::ContentSize => ffi::CLUTTER_REQUEST_CONTENT_SIZE,
            Self::__Unknown(value) => value,
}
    }
}
...
impl FromGlib<ffi::ClutterRequestMode> for RequestMode {
    unsafe fn from_glib(value: ffi::ClutterRequestMode) -> Self {
        match value {
            ffi::CLUTTER_REQUEST_HEIGHT_FOR_WIDTH => Self::HeightForWidth,
            ffi::CLUTTER_REQUEST_WIDTH_FOR_HEIGHT => Self::WidthForHeight,
            ffi::CLUTTER_REQUEST_CONTENT_SIZE => Self::ContentSize,
            value => Self::__Unknown(value),
}
    }
}
...
#[cfg(any(feature = "v0_8", feature = "dox"))]
#[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8")))]
impl glib::value::ValueType for RequestMode {
    type Type = Self;
}

#[cfg(any(feature = "v0_8", feature = "dox"))]
#[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8")))]
unsafe impl<'a> FromValue<'a> for RequestMode {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
/// The text direction to be used by [`Actor`][crate::Actor]<!-- -->s
#[cfg(any(feature = "v1_2", feature = "dox"))]
#[cfg_attr(feature = "dox", doc(cfg(feature = "v1_2")))]
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Hash)]
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "ClutterTextDirection")]
pub enum TextDirection {
    #[doc(alias = "CLUTTER_TEXT_DIRECTION_DEFAULT")]
    Default,
    #[doc(alias = "CLUTTER_TEXT_DIRECTION_LTR")]
    Ltr,
    #[doc(alias = "CLUTTER_TEXT_DIRECTION_RTL")]
    Rtl,
#[doc(hidden)]
    __Unknown(i32),
}
...
impl IntoGlib for TextDirection {
    ...
    fn into_glib(self) -> ffi::ClutterTextDirection {
        match self {
            Self::Default => ffi::CLUTTER_TEXT_DIRECTION_DEFAULT,
            Self::Ltr => ffi::CLUTTER_TEXT_DIRECTION_LTR,
            Self::Rtl => ffi::CLUTTER_TEXT_DIRECTION_RTL,
            Self::__Unknown(value) => value,
}
    }
}
...
impl FromGlib<ffi::ClutterTextDirection> for TextDirection {
    unsafe fn from_glib(value: ffi::ClutterTextDirection) -> Self {
        match value {
            ffi::CLUTTER_TEXT_DIRECTION_DEFAULT => Self::Default,
            ffi::CLUTTER_TEXT_DIRECTION_LTR => Self::Ltr,
            ffi::CLUTTER_TEXT_DIRECTION_RTL => Self::Rtl,
            value => Self::__Unknown(value),
}
    }
}
