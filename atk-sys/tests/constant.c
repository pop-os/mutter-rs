...
int main() {
    PRINT_CONSTANT(ATK_BINARY_AGE);
    PRINT_CONSTANT((guint) ATK_HYPERLINK_IS_INLINE);
    PRINT_CONSTANT(ATK_INTERFACE_AGE);
    ...
    PRINT_CONSTANT(ATK_MAJOR_VERSION);
    PRINT_CONSTANT(ATK_MICRO_VERSION);
    PRINT_CONSTANT(ATK_MINOR_VERSION);
    ...
    PRINT_CONSTANT(ATK_VERSION_MIN_REQUIRED);
